...
export const LongCardInfo = ({ address, icon, id, price, liquidityTitle }: LongCardInfoProps) => {
    ...
    return (
        <div className={`flex p-4 rounded-main bg-bg-block justify-center md:justify-between flex-col md:flex-row items-center md:items-start`}>
            ...
            <div className="flex items-center gap-5 flex-col md:flex-row mt-7 md:mt-0">
